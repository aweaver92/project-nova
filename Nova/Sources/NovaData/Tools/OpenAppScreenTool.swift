...
public struct OpenAppScreenTool: Tool {
    ...
    Sage: tasks; Scholar: study; Ivy: garden, plants, plant_scan, garden_walk, garden_plan). Only works for \
    screens you own — if the user wants another specialist's screen, tell them \
    to talk to that agent (or ask Nova to switch_agent). Do not invent a \
    configuration error.
    """
    public let requiresConfirmation = false
    public let parametersJSON = """
    {"type":"object","properties":{"destination":{"type":"string","description":"Screen id or phrase, e.g. shopping_list, pantry, coding, training, tasks, study, garden, plants, garden_walk, garden_plan."}},"required":["destination"],"additionalProperties":false}
    """
