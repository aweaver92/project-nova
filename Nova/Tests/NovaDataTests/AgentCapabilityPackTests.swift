...
final class AgentCapabilityPackTests: XCTestCase {
    func testBuiltInAgentsHaveDistinctAllowlists() {
        ...
        XCTAssertTrue(max.toolNames!.contains("ring_readiness"))
        XCTAssertTrue(max.personality.contains("Training screen"))
        XCTAssertTrue(max.personality.contains("ring_readiness"))
        ...
        XCTAssertTrue(remy.toolNames!.contains("import_recipe"))
        XCTAssertTrue(remy.toolNames!.contains("build_shopping_from_meal_plan"))
        XCTAssertTrue(remy.toolNames!.contains("lookup_food_nutrition"))
